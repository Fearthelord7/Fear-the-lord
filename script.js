...
document.addEventListener("DOMContentLoaded", () => {
  ...
  productButtons.forEach((button, index) => {
    button.addEventListener("click", () => {
      ...
      const activeSlideIndex = parseInt(sliderTrack.getAttribute("data-active-slide") || "0");
  ...
  if (checkoutBtn) {
    checkoutBtn.addEventListener("click", async (e) => {
      ...
      try {
        ...
        const stripe = window.Stripe('pk_test_51QzvO507sof0o0hWPvys2KZUsUqF2ITa7Ohu3qXwAvL4FXJtBjqJGKMUu30srjAKaSo3QRmXQ2rno17rWXNytMWX00iVkbi11B');
  ...
  function initProductSliders() {
    ...
    sliders.forEach(slider => {
      ...
      prevBtn.addEventListener('click', () => {
        const currentIndex = parseInt(track.getAttribute('data-active-slide'));
